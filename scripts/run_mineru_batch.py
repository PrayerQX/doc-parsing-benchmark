...
def main() -> int:
    ...
    parser.add_argument("--mineru-exe", required=True)
    ...
    for image_path in samples:
        ...
        try:
            ...
            per_sample[sample_id] = {
                ...
                "error": None if output_path else "mineru_completed_without_markdown_output",
            }
            ...
            per_sample[sample_id] = {
                ...
                "error": f"mineru_exit_{exc.returncode}",
            }

    summary = {
        "model": "MinerU-2.5-VLM",

...
set ROOT=%REPO_ROOT%\benchmark_quick_resilient
...
"%BENCH_PYTHON%" "%REPO_ROOT%\scripts\run_benchmark_pipeline.py" ^
  ...
  1>>"%ROOT%\jobs\benchmark_quick_resilient_current.out.log" ^
  2>>"%ROOT%\jobs\benchmark_quick_resilient_current.err.log"
